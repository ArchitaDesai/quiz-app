...
# Note 1. EXECUTE THIS SCRIPT EITHER FROM "frontend" OR FROM ROOT DIRECTORY OF PROJECT.
# Note 2. DON'T FORGET TO ACTIVATE VIRTUALENV BEFORE EXECUTING build.sh
...
# If current directory isn't "frontend", that is we're in the build.sh's directory
